...
# Aplicación Android desarrollada en Java que permite convertir valores entre Dólar (USD) y Euro (EUR).
- El dólar se usa como base (1 USD = 1) y el usuario puede modificar el valor del euro.

## Lógica de Conversión en dos pasos:
...
## Arquitectura: La aplicación implementa el patrón MVVM (Model - View - ViewModel):
